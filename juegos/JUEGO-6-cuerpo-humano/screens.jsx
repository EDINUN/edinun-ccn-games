...
// ─────────────────────────────────────────────────────────────
// Fondo + glifos decorativos del tema (cuerpo humano). Mismo patrón que la
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 8 }}>
              EDINUN · Aparatos y sistemas del cuerpo humano {/* ← PERSONALIZAR: tema del juego */}
            </div>
          ...
          <div style={{
            ...
            Misión: Cuerpo Humano 🧠 {/* ← PERSONALIZAR: subtítulo corto */}
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    ...
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "cuerpo-humano",
      currentCatLabel: "Cuerpo humano",
    }));
    go("game");
  }
