...
// ─────────────────────────────────────────────────────────────
// Fondo + glifos decorativos del tema (estados del agua). Mismo patrón que la
...
function CharacterScreen({ app, setApp, go }) {
  ...
  const [sel, setSel] = useState(
    app.character && app.character !== "astronauta" ? app.character : "quimica"
  );
  ...
  function choose() {
    ...
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "estados-del-agua",
      currentCatLabel: "Estados del agua",
    }));
    go("game");
  }
