// screens.jsx — Pantallas base del shell EDINUN GAMES (Ciencias Naturales).
...
// ─────────────────────────────────────────────────────────────
// Fondo + glifos decorativos del tema (ciclo del agua). Mismo patrón que la
...
const CHALK_GLYPHS = [
  ...
  { c: "☁️",  l: "16%", t: "27%", r: "6deg",   s: "0.5em"  },
  { c: "🌧️", l: "30%", t: "11%", r: "-5deg",  s: "0.46em" },
  { c: "☀️",  l: "58%", t: "12%", r: "-4deg",  s: "0.48em" },
  { c: "🌊",  l: "73%", t: "9%",  r: "8deg",   s: "0.55em" },
  { c: "💧",  l: "90%", t: "15%", r: "6deg",   s: "0.52em" },
  { c: "★",   l: "44%", t: "8%",  r: "4deg",   s: "0.5em"  },
  { c: "❄️",  l: "3%",  t: "45%", r: "-6deg",  s: "0.55em" },
  { c: "☁️",  l: "95%", t: "44%", r: "-8deg",  s: "0.52em" },
  { c: "💧",  l: "86%", t: "56%", r: "8deg",   s: "0.46em" },
  { c: "🏔️", l: "7%",  t: "80%", r: "12deg",  s: "0.55em" },
  { c: "🌧️", l: "30%", t: "86%", r: "-4deg",  s: "0.48em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "☁️",  l: "84%", t: "6%",  r: "6deg",   s: "0.62em" },
  { c: "🌊",  l: "92%", t: "72%", r: "-12deg", s: "0.58em" },
  { c: "❄️",  l: "3%",  t: "82%", r: "12deg",  s: "0.58em" },
  { c: "✦",   l: "46%", t: "4%",  r: "-4deg",  s: "0.5em"  },
  { c: "☀️",  l: "7%",  t: "46%", r: "-4deg",  s: "0.52em" },
  { c: "★",   l: "88%", t: "40%", r: "8deg",   s: "0.5em"  },
  { c: "💨",  l: "22%", t: "22%", r: "10deg",  s: "0.5em"  },
  { c: "🌧️", l: "70%", t: "22%", r: "-6deg",  s: "0.52em" },
  { c: "💧",  l: "32%", t: "70%", r: "8deg",   s: "0.5em"  },
  { c: "🏔️", l: "62%", t: "78%", r: "-10deg", s: "0.52em" },
  { c: "✦",   l: "18%", t: "58%", r: "14deg",  s: "0.46em" },
  { c: "☁️",  l: "78%", t: "56%", r: "-8deg",  s: "0.5em"  },
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 8 }}>
              EDINUN · Ciclo vital del agua en la naturaleza {/* ← PERSONALIZAR: tema del juego */}
            </div>
          ...
          <div style={{
            ...
            El viaje del agua 💧 {/* ← PERSONALIZAR: subtítulo corto */}
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  // Predeterminado de este juego: Mía (química). El shell arranca con
  // character "astronauta", así que tratamos ese valor inicial como "sin elegir"
  // y mostramos a Mía; si el niño ya eligió otro guía, se respeta.
  const [sel, setSel] = useState(
    app.character || "astronauta"
  );
  ...
  function choose() {
    ...
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "ciclo-del-agua",
      currentCatLabel: "Ciclo del agua",
    }));
    go("game");
  }
