...
Copiar `juegos/_PLANTILLA/` → `juegos/JUEGO-N-<slug>/` (N = siguiente ordinal
...
- **Personaje destacado** — definir el `charId` (astronauta/naturalista/quimica/geologo) que mejor
