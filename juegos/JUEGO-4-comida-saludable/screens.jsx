...
// ─────────────────────────────────────────────────────────────
// Fondo + glifos decorativos del tema (comida saludable). Mismo patrón que la
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 8 }}>
              EDINUN · Cuido mi salud física y mental {/* ← PERSONALIZAR: tema del juego */}
            </div>
          ...
          <div style={{
            ...
            Comida saludable 🍎 {/* ← PERSONALIZAR: subtítulo corto */}
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    ...
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "comida-saludable",
      currentCatLabel: "Comida saludable",
    }));
    go("game");
  }
